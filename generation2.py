...
# model_dir     : location of model checkpoint (required)
# prompt        : prompt for text generation (required)
# seed          : random seed for TensorFlow, numpy and PythonHash'
# generate_num  : number of tokens to generate
# temperature   : temperature for sampling distribution; 0 means greedy
# nucleus       : cumulative probability cutoff for nucleus sampling; 0 means no nucleus sampling
...
result  = generate(
    args.model_path, 
    'Links https://www.cnn.com/world/09/19/2019/unicorns-found-in-andes-mountains', 
    )
print('############################################')
print('############################################')
print('############################################')
